...
public class EventOrganizerRatingServiceImpl implements EventOrganizerRatingService {
    ...
    @Override
    public RantingCreateDtoResponse create(Long eventId, RantingCreateDtoRequest rantingCreateDtoRequest,
                                           UserVO userVO) {
        ...
        eventOrganizerRatingRepo.findByUser(modelMapper.map(userVO, User.class))
        ...
        return modelMapper.map(eventOrganizerRating, RantingCreateDtoResponse.class);
    }
}
