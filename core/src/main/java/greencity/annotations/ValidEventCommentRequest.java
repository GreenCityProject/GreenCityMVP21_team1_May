...
import greencity.validator.ValidEventCommentDtoRequest;
...
@Constraint(validatedBy = ValidEventCommentDtoRequest.class)
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.PARAMETER)
public @interface ValidEventCommentRequest {
    /**
     * Defines the message that will be showed when the input data is not valid.
     *
     * @return message
     */
    String message() default "Your message contains forbidden words";
