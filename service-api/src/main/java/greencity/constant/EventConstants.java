...
public final class EventConstants {
    public static final int MIN_DATES_COUNT = 1;
    public static final int MAX_DATES_COUNT = 7;
    public static final int MIN_TITLE_SIZE = 1;
    public static final int MAX_TITLE_SIZE = 70;
    public static final int MIN_DESCRIPTION_SIZE = 20;
